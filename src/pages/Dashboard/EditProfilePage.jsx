...
// NOTE: We no longer need 'Link' from react-router-dom
const EditProfilePage = ({ onBackClick }) => {
    
    const handleUpdate = (e) => { e.preventDefault(); console.log('Updating profile...'); };

    return (
        <div className="p-4">
            <div className="flex items-center mb-6">
                {/* CHANGED: This is now a button that calls the onBackClick function */}
                <button onClick={onBackClick} className="p-2 rounded-full hover:bg-gray-200">
            ...
            <form onSubmit={handleUpdate} className="p-6 space-y-6 bg-white shadow-md rounded-xl">
                {/* ... rest of the form code is the same ... */}
